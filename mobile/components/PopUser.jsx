...
const PopUser = ({ idUser, grupo }) => {
    const navigation = useNavigation();
    const {token} = useContext(AuthContext)
    const [modalVisible, setModalVisible] = useState(false);
    async function handleDeleteUser() {
        const url = `${BASE_URL}/api/usuarios/${idUser}`;
        try {
    ...
    function handleEditUser() {
        if(grupo === 'Docentes'){
            navigation.navigate('EditDocente', { idUser });
        }else if(grupo === 'Alunos'){
            navigation.navigate('EditAluno', { idUser });
        }
    ...
    return (
          ...
          onRequestClose={() => {
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    <Text style={styles.modalText}>Deseja excluir o usuário?</Text>
        ...
        <Menu>
            ...
            >
                <MenuOption onSelect={handleEditUser}>
